...
- 1:39:50 Контроль автоиатического запонения файла ` inventiry ` теми IP адресами, которые появились в выводе при окончании отработки команды ` terraform apply -auto-approve `
