...
Команда ` docker attach ` — если необходимо перенаправить поток данных в контейнер.
```bash
...
#### Подключение локальной директории из хостовой машины в контейнер для сохранения и общего использования данных.
