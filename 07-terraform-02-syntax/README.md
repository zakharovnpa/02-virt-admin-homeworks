...
**Ответ:** УЗ на AWS не создано. Имеется УЗ на Яндекс.Облаке и всё ДЗ выполнено для него.
...
**Ответ:** Создана учебная УЗ с использованием промо-кода от Нетологии. 
...
**Ответ:** 
1. Создана yandex_compute_instance.

2. Листинг команды ` terraform plan ` в Yandex.Cloud
...
[Ссылка на репозиторий с файлами конфигурации Terraform](https://github.com/zakharovnpa/devops-netology/tree/main/terraform)
